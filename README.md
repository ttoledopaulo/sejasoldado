...
4. Configure as variáveis de `.env.example` localmente e na Vercel. Use a **Project URL** e a **Publishable key** do Supabase. O Blob adiciona `BLOB_READ_WRITE_TOKEN` automaticamente quando é conectado ao projeto.
